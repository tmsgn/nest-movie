          ...
          return (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col justify-end p-6 space-y-2">
                ...
                <button className="mt-2 flex w-fit c items-center gap-2 bg-yellow-400 text-black px-4 py-2 rounded-full font-semibold shadow hover:bg-yellow-300 transition">
                  <FaPlay />
                  Play
                </button>
              </div>

    ...
    <div className='relative'>
      <div className="cursor-pointer transition-transform transform hover:scale-105 relative">
        <div className='relative'>
          ...
          <div className='absolute h-full w-full bg-gray-200 bg-opacity-50 rounded-lg opacity-0 hover:opacity-100 transition-opacity'></div>
        ...
        <div className="mt-2">
          <h1 className='text-xs md:text-sm font-medium text-gray-300 '>

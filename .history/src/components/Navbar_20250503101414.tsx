    ...
    <nav className="bg-gray-900 text-white px-4 py-3 shadow-md w-screen overflow-x-hidden">
      <div className="max-w-6xl mx-auto flex flex-wrap justify-between items-center gap-4">
        ...
        >
          ...
          {query && (
            <div
              className="absolute left-0 right-0 top-full mt-2 max-h-60 overflow-y-auto bg-gray-800 text-white rounded-md shadow-lg z-50"
              style={{ width: 'calc(100% - 2rem)' }} // Ensures dropdown takes full width minus padding
            >
              {loading ? (

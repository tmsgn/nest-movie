      ...
      <div className="cursor-pointer rounded-lg p-1 group transition-transform transform hover:scale-105 relative">
        <div className="relative">
          <div className="absolute inset-0 flex items-center justify-center">
            <span className="material-symbols-outlined scale-250 text-yellow-500 opacity-0 group-hover:opacity-400  cursor-pointer">
              play_circle
            </span>
          </div>
          ...
          <Image
            ...
            width={500}
            height={750}
            className="object-cover group-hover:opacity-70 rounded-lg"
          />
        </div>
        <div className="mt-2">

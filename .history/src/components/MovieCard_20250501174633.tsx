  ...
  return (
    <div className="relative">
      <div className="cursor-pointer rounded-lg p-1 group transition-transform transform hover:scale-105 relative">
        <div className="relative">
          <div className="absolute inset-0 flex items-center justify-center bg-black/30 opacity-0 group-hover:opacity-200 transition-opacity">
            <span className="material-symbols-outlined scale-250 text-white  cursor-pointer">
              play_circle
            </span>
          </div>

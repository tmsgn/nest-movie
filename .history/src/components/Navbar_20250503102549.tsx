    ...
    <nav className="bg-gray-900 text-white  px-4 py-3 shadow-md w-screen overflow-x-hidden">
      <div className="max-w-6xl mx-auto flex flex-wrap justify-between items-center gap-4">
        ...
        <form
          ...
          style={{ zIndex: 50 }} // Ensure it has a high z-index
        >
          <input
            type="text"
            name="query"
          ...
          {query && (
           <div className="absolute left-0 right-0 top-10 max-h-60 overflow-y-auto bg-gray-800 text-white rounded-md shadow-lg z-50">
           {loading ? (
             ...
             results.map((movie, index) => (
               ...
               >
                 <h3 className="text-sm px-4 py-2 hover:bg-gray-700 transition">
                   {movie.title}
                 </h3>
               </Link>
             ))

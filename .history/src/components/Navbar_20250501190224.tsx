...
import { searchMovies } from '@/lib/fetchMovies'; // Ensure this function is properly implemented and typed.
    ...
    <nav className="bg-gray-900 text-white px-4 py-3 shadow-md">
      <div className="max-w-6xl mx-auto flex flex-wrap justify-between items-center gap-4">
        ...
        >
          ...
          {query && (
            <div className="absolute left-0 right-0 top- max-h-60 overflow-y-auto bg-gray-800 text-white rounded-md shadow-lg z-10">
              {loading ? (

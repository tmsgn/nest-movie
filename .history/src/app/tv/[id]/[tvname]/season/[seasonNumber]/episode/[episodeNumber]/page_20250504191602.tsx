        ...
        <div className="flex flex-col  lg:flex-row gap-4">
          ...
          <div className="flex flex-col lg:w-1/3">
            <div className="flex flex-col md:flex-row gap-4 md:gap-8">
              <Image
                className="rounded-lg h-auto object-cover w-32 sm:w-40 md:w-48 lg:w-52 xl:w-60 mx-auto md:mx-0"
              ...
              <div className="flex flex-col justify-start flex-1">
                ...
                <div className="flex flex-wrap gap-2 mt-4">
                  {tvshow.genres.map((g: any) => (
                    <span
                      key={g.id}
                      className="text-xs md:text-sm font-medium text-gray-700 bg-yellow-400 px-2 py-1 rounded"
                    >
                      {g.name}
                    </span>
                  ))}

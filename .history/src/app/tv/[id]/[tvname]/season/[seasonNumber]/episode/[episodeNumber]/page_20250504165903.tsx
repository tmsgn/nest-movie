...
export default function EpisodePage() {
  ...
  useEffect(() => {
    setLoading(true); // Set loading to true when fetching the TV show details
    async function fetchTvshow() {
      if (id) {
        ...
        setLoading(false); // Set loading to false after fetching TV show details
      }
    }
    fetchTvshow();
  }, [id]);
  ...
  useEffect(() => {
    ...
    async function fetchEpisodes() {
      if (id && selectedSeason) {
        ...
        setCurrentPage(1);
        setLoading(false); // Set loading to false after fetching episodes
      }
    }
    fetchEpisodes();
  }, [id, selectedSeason]);
  ...
  // Only show the component when tvshow is loaded, no need to set loading here
  if (loading) {
    return (

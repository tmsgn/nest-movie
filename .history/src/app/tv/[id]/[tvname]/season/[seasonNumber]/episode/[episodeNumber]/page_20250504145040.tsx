            ...
            {tvshow && (
              <>
                ...
                <div className="ml-4 flex flex-col justify-start">
                  ...
                  <h1 className="mt-2 bg-yellow-400 w-fit p-0.5 rounded-sm text-gray-700">S{seasonNumber}-E{episodeNumber}</h1>
                  
                  <div className="mt-3">
                    <span className="flex gap-2">
                      <h1>Release date:</h1>
                      <h1> {new Date(tvshow.first_air_date).toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })}</h1>
                    </span>
                    <span className="flex gap-2">
                      <h1>Others:</h1>
                      <h1>{tvshow.number_of_seasons} Seasons, {tvshow.number_of_episodes} Episodes</h1>
                    </span>
                    ...
                    <span className="flex gap-2 mt-2">
                      <h1>Rating:</h1>
                      <h1>{tvshow.vote_average} / 10 ({tvshow.vote_count} votes)</h1>
                    </span>
                  </div>

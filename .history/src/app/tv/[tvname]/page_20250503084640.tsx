    ...
    <div className="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mt-12">
        <div className="flex items-center gap-2 mb-4">
          <button className="bg-gray-800 text-white px-4 py-2 rounded-lg text-lg font-semibold flex items-center gap-2">
            Season 1
            <svg
              className="w-5 h-5"
              fill="none"
          ...
          {/* Add season dropdown/filter if needed */}
        </div>
        <div className="overflow-x-auto">
          <div className="flex flex-nowrap gap-4 pb-2">
            {episodesBySeason[1]?.map((episode) => (
              <div
              ...
              >
                ...
                <div className="p-2">
                  ...
                  <div className="text-xs text-gray-400">
                    Season 1&nbsp;&nbsp;Episode {episode.episode_number}
                  </div>
                </div>
              </div>
            ))}

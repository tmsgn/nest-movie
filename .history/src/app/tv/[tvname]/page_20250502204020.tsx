      ...
      <div className="w-screen flex sm:flex-row  flex-col">
        ...
        <div className="mx-4 bg-red-400">
          ...
          <div className="max-w-2xl">
            ...
            {cast && cast.length > 0 && (
              <div className="flex ">
                <h2 className="mr-3">Casts:</h2>
                <h1>{cast.slice(0, 3).map((member) => member.name).join(", ")}</h1>
              </div>
            )}
        ...
        <div>
            <h1 className="text-2xl font-bold mt-4">Episodes</h1>

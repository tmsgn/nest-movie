...
export default function Page({ tvshow = { name: "Default TV Show", overview: "Default overview", first_air_date: "2023-01-01" } }: { tvshow?: any }) {
  ...
  if (!tvshow) {
    return <p className="text-gray-500">TV show data is not available</p>;
  }

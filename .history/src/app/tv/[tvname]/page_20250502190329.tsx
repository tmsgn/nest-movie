...
export default function TVpage({
  ...
  return (
    <div className="flex flex-col lg:flex-row items-start justify-start space-y-8 lg:space-y-0 lg:space-x-8 p-6 bg-gray-100">
      <div className="max-w-xs w-full">
        {tvshow && tvshowDetail ? (
          <Image
            ...
            width={300}
            height={450}
            className="rounded-lg shadow-xl w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl"
          />
        ) : null}
      </div>

...
export default function TVPageContent({
  ...
  const currentEpisodes = episodesBySeason[parseInt(selectedSeason)]?.slice(
    (currentPage - 1) * episodesPerPage,
    currentPage * episodesPerPage
  );

  const totalPages = Math.ceil(
    (episodesBySeason[parseInt(selectedSeason)]?.length || 0) / episodesPerPage
  );
              ...
              {seasonKeys.map((season) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    setCurrentPage(1); // reset page on season change
            ...
            >
              ...
              <div className="p-2">
                ...
                <div className="text-xs text-gray-400">
                  Season {selectedSeason} - Ep {episode.episode_number}
                </div>
              </div>
            </div>
          ))}

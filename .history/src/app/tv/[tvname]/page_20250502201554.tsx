        ...
        <div className="w-screen flex sm:flex-row flex-col">
          ...
          <div className="mx-4 text-ellipsis">
            ...
            <div>
              ...
              <h1 className="text-sm font-medium gap-2 text-gray-400 mt-2">
                Genere: 
                {tvshowDetail?.genres && tvshowDetail.genres.length > 0
                  ? tvshowDetail.genres.map((genre: { name: string }) => genre.name).join(", ")
                  : "No genres available"}
              </h1>
            </div>
          </div>

...
export default function TVpage({
  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center space-y-8 lg:space-y-0 lg:space-x-8 p-6 bg-gray-100">
      ...
      <div className="w-full lg:w-1/3 space-y-4">
        {tvshow && tvshowDetail ? (
          ...
          <p className="text-center text-lg font-semibold text-gray-600">No details available</p>
        )}
      </div>
    </div>
  );

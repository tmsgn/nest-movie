...
import TVPageContent from "@/components/TVPageContent";
...
// Fetch TV Show details by title
...
// Fetch cast details for a TV Show
...
// Fetch episodes by season for a TV Show
...
export function generateMetadata({ params }: { params: { tvname: string } }): Metadata {
  const title = decodeURIComponent(params.tvname || "");
  return {
    title: `Details for: ${title}`,
    description: `Detailed information about the TV show: ${title} on MovieNest`
  };
}

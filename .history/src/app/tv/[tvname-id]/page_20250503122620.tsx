...
// Fetch TV show details based on the title
...
export default async function TVPage({
  ...
  const title = params.tvname.replace(/-/g, " "); // Normalize the tvname in the URL to match API query format

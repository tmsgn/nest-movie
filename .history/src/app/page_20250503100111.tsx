...
import { getTrendingMovies, getTrendingTVShows } from "@/services/api"; // Adjust the path based on your API service file
import { Movie, TVShow } from "@/types"; // Adjust the path based on where your types are defined
